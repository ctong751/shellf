/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5e1ff7411f0f0fb15f58648ec2b5e3dc)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "TMDB_API_KEY">> {}
}
